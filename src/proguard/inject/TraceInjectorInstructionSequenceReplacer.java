...
public class TraceInjectorInstructionSequenceReplacer
        ...
        ConstantVisitor
{
    ...
    private final TraceInjectorInstructionSequenceMatcher instructionSequenceMatcher;
    ...
    /**
     * @param traceInjectorInstructionSequenceMatcher a suitable instruction sequence matcher.
     ...
     *                                   load instructions.
     */
    public TraceInjectorInstructionSequenceReplacer(TraceInjectorInstructionSequenceMatcher traceInjectorInstructionSequenceMatcher,
    ...
    {
        this.instructionSequenceMatcher = traceInjectorInstructionSequenceMatcher;
    ...
    public void visitAnyInstruction(Clazz clazz, Method method, CodeAttribute codeAttribute, int offset, Instruction instruction)
    {
        ...
        instructionSequenceMatcher.setVisitInfo(clazz, method, codeAttribute, offset, instruction);
        ...
        {
            if (instructionSequenceMatcher.isIvokeOp())
            {
                // insert flow trace before and after functions invoke
            }
            else if (matchedInstructionsUnmodified())
            {
                // replace by patern
    ...
    {
        if (constantIndex == TraceInjectorInstructionSequenceConstants.CLASS_NAME)
