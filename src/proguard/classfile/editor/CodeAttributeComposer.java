             ...
             LocalVariableTypeInfoVisitor
{
    ...
    public void appendException(ExceptionInfo exceptionInfo)
    {
        ...
        if (DEBUG)
        {
            Logger.out_println(" -> ["+exceptionInfo.u2startPC+" -> "+exceptionInfo.u2endPC+": "+exceptionInfo.u2handlerPC+"]");
        }
    ...
    public int insertLineNumber(int minimumIndex, LineNumberInfo lineNumberInfo)
    {
        ...
        if (DEBUG)
        {
            Logger.out_println(" -> ["+lineNumberInfo.u2startPC+"] line "+lineNumberInfo.u2lineNumber+(lineNumberInfo.getSource()==null ? "":" ["+lineNumberInfo.getSource()+"]"));
        }
    ...
    public void visitCodeAttribute(Clazz clazz, Method method, CodeAttribute codeAttribute)
    {
        if (DEBUG)
        {
            Logger.out_println("CodeAttributeComposer: putting results in ["+clazz.getName()+"."+method.getName(clazz)+method.getDescriptor(clazz)+"]");
        }
